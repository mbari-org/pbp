...
# My netcdf:
minute0_file = '/Volumes/PAM_Analysis/pypam-space/test_output/milli_psd_20220902_000000.nc'
minute0_ds = xr.open_dataset(minute0_file)
# minute0_ds['__xarray_dataarray_variable__'][0].plot()

# difference:
diff = minutes0to19_ds['millidecade_bands'][0] - minute0_ds['__xarray_dataarray_variable__'][0]
